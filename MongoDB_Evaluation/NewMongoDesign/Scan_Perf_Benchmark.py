...
print("Average Execution Time with Margin Scan: {0}".format (str(cumulativeExecTime/numRuns)))
...
for i in range(0,numRuns):
    ...
    endTime = datetime.datetime.now()
    cumulativeExecTime += (endTime - startTime).total_seconds()
print("Average Execution Time with No Margin Scan: {0}".format (str(cumulativeExecTime/numRuns)))
